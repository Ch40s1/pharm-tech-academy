  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <p>
        ...
        (e.g., b.i.d., t.i.d., Roman numerals), abbreviations, medical terminology, and symbols for days supply,
      ...
      <section className="mt-8">
        ...
        <div>
          ...
          <p>
            First, let&apos;s rephrase the problem to better understand it: We
            have a drug with a concentration of 4 mg/mL, and we need to
            administer 0.35 mg to an infant. The volume needed at the current
            concentration would be 0.08 mL, which is difficult to measure
            accurately. To make this easier, we want to dilute the solution to a
            concentration of 1 mg/mL. Our task is to find the volume of diluent
            needed and the final volume to be measured for the dose.
            <br />
          ...
          <p>
            ...
            <a
              ...
              href="https://www.wikihow.com/Calculate-the-Concentration-of-a-Solution"
            >
